...
const ShortenLink = () => {
    ...
    return <>
        <div className="flex justify-center items-center min-h-screen">
            <div className="rounded-xl bg-slate-400 p-10 flex justify-between items-center">
                ...
                <div>
                    <h2 className="text-xl font-bold text-slate-300" >Redirecting...</h2>
                    <hr className="border border-slate-500 mt-2" />
                    <p className="text-slate-300">Verifying security and URL.</p>
                </div>
            </div>
        </div>
    </>
